...
public class DBConstants {
	...
	public static final String dbUrl = "jdbc:mysql://servicedesigntoolkit.c0yhynxdv06j.ap-southeast-1.rds.amazonaws.com:3306/phoenix";
	public static final String dbUserName = "admin";
	public static final String dbPassword = "adminadmin";
